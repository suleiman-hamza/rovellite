...
<template>
  <section id="contactus" class="bg-[url(/images/landing-page/Skyscrapper-city.png)] bg-contain md:bg-cover bg-bottom bg-no-repeat pt-16 pb-24 md:pt-32 md:pb-42 ">
    <UContainer
      class="mx-auto md:flex justify-between gap-18"
    >
      <div class="">
