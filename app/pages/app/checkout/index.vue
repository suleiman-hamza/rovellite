  ...
  <main class="">
    <div class="flex flex-col gap-4 md:flex-row">
      ...
      <div class="flex justify-between gap-4 items-center mb-4">
        <p class="text-base md:text-[18px] font-normal text-[#4D5155] capitalize">Item details</p>
        <UButton label="Edit Cart" leadingIcon="i-lucide-edit-3" variant="ghost"
      ...
      <div class="mb-4 md:mb-8">
        ...
        <div class="border border-secondary p-3 rounded-sm flex gap-2.5 items-center md:gap-4 max-w-80">
          ...
          <div>
            ...
            <p class="text-[14px] md:text-[15px] text-[#808385]">Balance: {{ displayedBalance }}</p>
          </div>
