    ...
    <div v-else class="flex flex-col gap-4 md:flex-row">
      ...
      <section class="p-4 bg-white rounded-[20px] md:flex-1">
        <div class="flex justify-between gap-4 items-center mb-4">
          <p class="text-base md:text-[28px] font-bold text-[#4D5155]">Cart</p>
          <UButton label="Clear all" @click="cartStore.clearCart" variant="ghost" class="rounded-sm px-1 py-0.5 text-[#808385] outline outline-[#80838554] text-sm" :ui="{ leadingIcon: 'size-3' }" />
        </div>
         ...
         <section class="p-4 bg-white rounded-[20px]">
           ...
           <div class="text-[#565252]">
             ...
             <div class="text-[15px] md:text-[16px] flex gap-8 justify-between mb-2">
              ...
              <div class="text-[15px] md:text-[16px] flex gap-8 justify-between mb-2">
                <p>Bonus to Earn</p>
                <p class="bg-secondary text-primary rounded-sm px-1 p-0.5">#0</p>
              </div>
              <!--total amount-->
